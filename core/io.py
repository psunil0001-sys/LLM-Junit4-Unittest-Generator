...
_KINDS = {
    ...
    "dim": "\033[2m",
    "info": "\033[96m",
    # Live model tokens on dark terminals: faded vs full white.
    "reasoning": "\033[38;5;245m",  # faded white — thinking / reasoning
    "model": "\033[97m",  # bright white — final model answer content
    "claude": "\033[97m",  # alias of model (legacy kind name)
    "tool_start": "\033[38;5;229m",  # light yellow — [tool:start] lines
}
